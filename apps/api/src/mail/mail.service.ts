...
export class MailService {
  ...
  getAuthUrl(): string {
    if (!this.oAuth2Client) throw new Error('OAuth2 Client not initialized because ID/Secret missing');
   ...
   */
  private createRawMessage(to: string, subject: string, text: string, html?: string): string {
