  ...
  "pointer-events-none block rounded-full bg-surface shadow-lg ring-0 transition-transform",
  {
    variants: {
      variant: {
        ...
        premium: "h-6 w-6 shadow-md data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
      },
    },
    defaultVariants: {
      variant: "default",
