...
const switchThumbVariants = cva(
  "pointer-events-none block rounded-full bg-inputSurface-background shadow-[0_1px_2px_hsl(var(--shadow-color)/0.16)] ring-0 transition-transform",
  {
    variants: {
      variant: {
        default: "h-5 w-5 data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
        premium: "h-6 w-6 shadow-[0_2px_4px_hsl(var(--shadow-color)/0.18)] data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
      },
    },
    defaultVariants: {
      variant: "default",
