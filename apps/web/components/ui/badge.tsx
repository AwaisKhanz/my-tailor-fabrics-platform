...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border !px-1 !py-0 text-xs font-semibold tracking-[0.01em] transition-colors focus:outline-none focus:ring-2 focus:ring-interaction-focus focus:ring-offset-2 focus:ring-offset-background",
  {
    variants: {
      variant: {
        ...
        destructive: "border-destructive/25 bg-error-muted text-destructive",
        ...
        premium:
          "border-primary/25 bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-tight text-primary",
      },
      size: {
