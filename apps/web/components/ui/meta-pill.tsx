...
const metaPillVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3 py-1.5 text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground shadow-sm",
  {
    variants: {
      tone: {
        default: "",
