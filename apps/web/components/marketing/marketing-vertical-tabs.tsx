  ...
  return (
    <div className={cn("w-full", className)}>
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12 lg:gap-12">
        <div className="order-2 flex flex-col justify-center lg:col-span-5 lg:order-1">
            ...
            {items.map((service, index) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "group relative flex items-start gap-4 border-t border-border/50 py-4 text-left transition-all duration-500 first:border-0 md:py-5",
                    isActive
                      ? "text-foreground"
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col gap-2">
                    <span
                      className={cn(
                        "text-xl font-medium tracking-tight transition-colors duration-500 md:text-2xl",
                    ...
                    <AnimatePresence mode="wait">
                      {isActive ? (
                        ...
                        >
                          <p className="max-w-sm pb-1 text-sm font-normal leading-6 text-muted-foreground">
                            {service.description}
                          </p>
                        </m.div>
                      ) : null}
        ...
        <div className="order-1 flex h-full flex-col justify-end lg:col-span-7 lg:order-2">
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden rounded-3xl border border-border/40 bg-muted/30 md:aspect-[16/10]">
              <AnimatePresence
                initial={false}
                custom={direction}
                mode="popLayout"
              >
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-background/80 via-background/10 to-transparent opacity-70" />
                </m.div>
              </AnimatePresence>
