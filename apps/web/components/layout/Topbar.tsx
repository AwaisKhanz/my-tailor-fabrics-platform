  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40 px-3 pt-3 sm:px-4 lg:px-5">
      <div className="space-y-2">
        <div className="dashboard-shell-topbar flex h-[4.5rem] w-full items-center gap-2 rounded-snow-28 px-3 sm:gap-3 sm:px-4 lg:px-5">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className="h-9 w-9 p-0">
                  <div className="flex h-full w-full items-center justify-center rounded-snow-16 bg-secondary text-sm font-semibold text-foreground">
              ...
              <DropdownMenuContent className="w-64" align="end" forceMount>
                ...
                <div className="px-2 pb-2 empty:hidden">
                  <Label className="mb-1 block text-xs font-bold uppercase tracking-tight text-muted-foreground">
                    Active Branch
                  </Label>
