...
const garments = [
  {
    name: 'Shalwar Kameez',
    customerPrice: 3500,
    measurementCategories: ['Shalwar', 'Kameez'],
    steps: [
      ['PRE_WASHING', 'Pre-washing', 1, 100],
      ['CUTTING', 'Cutting', 2, 200],
      ['STITCHING', 'Stitching', 3, 700],
      ['FINISHING', 'Finishing', 4, 150],
    ],
  },
  {
    name: 'Kameez Trouser',
    customerPrice: 3600,
    measurementCategories: ['Kameez', 'Trouser'],
    steps: [
      ['PRE_WASHING', 'Pre-washing', 1, 100],
      ['CUTTING', 'Cutting', 2, 220],
      ['STITCHING', 'Stitching', 3, 750],
      ['FINISHING', 'Finishing', 4, 150],
    ],
  },
  {
    name: 'Shirt',
    customerPrice: 1800,
    measurementCategories: ['Shirt'],
    steps: [
      ['CUTTING', 'Cutting', 1, 150],
      ['STITCHING', 'Stitching', 2, 400],
      ['FINISHING', 'Finishing', 3, 100],
    ],
  },
  {
    name: 'Pant',
    customerPrice: 2000,
    measurementCategories: ['Pant'],
    steps: [
      ['CUTTING', 'Cutting', 1, 170],
      ['STITCHING', 'Stitching', 2, 450],
      ['FINISHING', 'Finishing', 3, 100],
    ],
  },
  {
  ...
  },
  {
    name: 'Waistcoat',
    customerPrice: 2500,
    measurementCategories: ['Waistcoat'],
    steps: [
      ['CUTTING', 'Cutting', 1, 180],
      ['STITCHING', 'Stitching', 2, 500],
      ['FINISHING', 'Finishing & Button', 3, 120],
    ],
  },
  {
    name: 'Coat',
    customerPrice: 8000,
    measurementCategories: ['Coat'],
    steps: [
      ['CUTTING', 'Cutting', 1, 350],
      ['STITCHING', 'Stitching', 2, 1800],
      ['FINISHING', 'Finishing', 3, 300],
    ],
  },
  {
    name: 'Sherwani',
    customerPrice: 12000,
    measurementCategories: ['Sherwani'],
    steps: [
      ['CUTTING', 'Cutting', 1, 400],
      ['STITCHING', 'Stitching', 2, 2200],
      ['FINISHING', 'Finishing', 3, 350],
    ],
  },
  {
    name: '2-Piece Suit',
    customerPrice: 9000,
    measurementCategories: ['Shirt', 'Pant'],
    steps: [
      ['CUTTING', 'Cutting', 1, 320],
      ['STITCHING', 'Stitching', 2, 1600],
      ['FINISHING', 'Finishing', 3, 250],
    ],
  },
  {
    name: '3-Piece Suit',
    customerPrice: 12500,
    measurementCategories: ['Shirt', 'Pant', 'Waistcoat'],
    steps: [
      ['CUTTING', 'Cutting', 1, 400],
      ['STITCHING', 'Stitching', 2, 2200],
      ['FINISHING', 'Finishing', 3, 350],
...
async function main() {
  ...
  await prisma.$transaction(async (tx) => {
    ...
    for (let i = 0; i < categories.length; i += 1) {
      ...
      const created = await tx.measurementCategory.create({
        data: {
          name: category.name,
          sortOrder: i,
          isActive: true,
